...
function (_Component) {
  ...
  function editDevice(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(editDevice).call(this));
    _this.state = {
      data: {},
      files: []
    };
    ...
    _this.handleFileDrops = _this.handleFileDrops(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
...
//# sourceMappingURL=editDevice.js.de1c86a83b89cd6ba69a.hot-update.js.map