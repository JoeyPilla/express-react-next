...
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function componentWillUnmount() {
      ...
      window.addEventListener('dragover', this._onDragOver);
      document.getElementById(this.props.name + "dragbox").removeEventListener('dragleave', this._onDragLeave);
...
//# sourceMappingURL=editDevice.js.e5129ad38aa61f27aeff.hot-update.js.map